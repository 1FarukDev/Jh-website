  ...
  return (
    <section>
      ...
      <div>
        ...
        <section className="mt-[45px] mx-10 border border-t-0 border-b-0 border-[#8A8635]">
          {/* Mobile: 2 per row */}
          {Array.from({
            ...
            const mobileRowItems = featuredPrints.slice(mobileStart, mobileEnd);
                ...
                {mobileRowItems.map((item, colIndex) => (
                  <div
                    ...
                    className={`w-1/2 p-2 md:p-4 ${
                      colIndex !== mobileRowItems.length - 1
