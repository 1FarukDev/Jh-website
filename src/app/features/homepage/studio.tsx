        ...
        >
          ...
          <div className='absolute inset-0 flex flex-col justify-end p-4 sm:p-6 lg:p-8'>
            <div className='max-w-md'>
              ...
              <Button className='border px-6 sm:px-8 font-satoshi text-xs sm:text-sm bg-transparent border-white text-white hover:bg-white hover:text-black rounded-none py-2 transition-all duration-300'>
                Read More
          ...
          >
            ...
            <div className='absolute inset-0 flex flex-col justify-end p-4 sm:p-6'>
              <div className='max-w-sm'>
                <h2 className='text-lg sm:text-xl lg:text-2xl font-light text-white mb-2 sm:mb-3 tracking-wide leading-tight'>
                ...
                <Button className='border font-satoshi text-xs bg-transparent border-white text-white hover:bg-white hover:text-black rounded-none px-6 sm:px-8 py-2 transition-all duration-300'>
                  Read More
                  <ArrowRight className='ml-2 h-4 w-4' />
                </Button>
              </div>
