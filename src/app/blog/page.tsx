    ...
    <section className='py-26'>
      <div className='px-4'>
        ...
        <div className='mt-[40px] md:mt-[80px]'>
          ...
          <section className='grid md:grid-cols-3 gap-y-4 mt-10 gap-x-4'>
            {' '}
              ...
              return (
                <div className=' relative h-[600px] w-full' key={print.id}>
                  ...
                  <div className='absolute bottom-5 left-5 text-white'>
                    <h1 className='text-[20px] md:text-[30px] font-normal'>{print.title}</h1>
                    <p className='font-satoshi text-sm md:text-lg'>{print.description}</p>
