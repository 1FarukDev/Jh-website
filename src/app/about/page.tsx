        ...
        <section className="py-10">
            ...
            <div className="max-w-5xl mx-auto mt-10" data-aos="fade-up">
                ...
                <p className="text-center text-lg md:text-[20px] font-satoshi font-normal leading-[24px] md:leading-[25px] text-[#4E5157]">
                    JH Textile began as a love letter to materials, a quiet
                    experiment in a small, sunlit studio where fiber, dye, and
                    the rhythm of hand-printing told stories words couldn’t. It
                    was born from a deep fascination with texture, the emotional
                ...
                >
                    ...
                    decoration, it’s an invitation to feel, remember, and
                    connect.
                </p>
            </div>
                ...
                <div className="flex md:flex-row flex-col gap-4 px-4 mt-[50px]">
                    ...
                    >
                        <Image
                            src={Thread}
                            alt="Thread"
                            className="mb-[20px] md:mb-[48px] w-[30px] md:w-[60px]"
                        />
                        <h2 className="text-[40px]">Craft</h2>
                        <p className="font-satoshi font-normal text-[15px] md:text-[20px]">
                            We believe in slow, intentional making rooted in
                            material knowledge.
                        </p>
                    </div>
                    ...
                    >
                        ...
                        <p className="font-satoshi font-normal text-[15px] md:text-[20px]">
                            From plant-based dyes to long-lasting prints, we
                    ...
                    >
                        ...
                        <p className="font-satoshi font-normal text-[15px] md:text-[20px]">
                            Every piece reflects a narrative — of place, memory,
                            and design.
                        </p>
                    </div>
                </div>
            ...
            >
                ...
                >
                    ...
                    <p className="md:text-center text-lg md:text-[20px] font-satoshi font-normal leading-[24px] md:leading-[25px] text-[#4E5157]">
                        ...
                        connection. Over time, JH Textile evolved from a small
                        batch of experimental swatches into a thoughtful body of
                        work that bridges art and utility — from
                    ...
                    >
                        ...
                        more than decoration, it’s an invitation to feel,
