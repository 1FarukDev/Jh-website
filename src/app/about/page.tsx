  ...
  return (
    <section className='py-26'>
      ...
      <div className='max-w-5xl mx-auto mt-10'>
        <h1 className='text-[80px] text-center'>Who we are</h1>
        <p className='text-center text-[28px] font-satoshi font-normal leading-[32px] text-[#4E5157]'>
        ...
        <p className='text-center text-[28px] font-satoshi font-normal leading-[32px] text-[#4E5157] my-6'>
      ...
      <div className='mt-32'>
        <h1 className='text-[80px] text-center leading-tight'>what We Value</h1>
        <p className='text-lg text-[#4E5157] text-center font-satoshi'>
          A creative textile studio crafting meaningful prints, rooted in
          texture, tradition, and storytelling.
        </p>

        <div className='flex gap-4 items-center px-4 mt-[50px]'>
      ...
      <div className='flex gap-8 my-32 items-center px-4 '>
        <div className='w-1/2'>
          <h2 className='text-[#230D06] text-[64px] text-center font-light'>
            Our Story
          </h2>
          <p className='text-start text-[28px] font-satoshi font-normal leading-[32px] text-[#4E5157]'>
          ...
          <p className='text-start text-[28px] font-satoshi font-normal leading-[32px] text-[#4E5157] my-6'>
            Each piece from JH Textile carries the imprint of the maker’s hands
            and a commitment to process. From sketching and carving to printing
            and finishing, the journey is slow, thoughtful, and deliberate a
            counterbalance to fast production.
