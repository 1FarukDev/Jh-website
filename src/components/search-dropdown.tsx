...
function SearchDropdown({ onClose }: Props) {
  ...
  const { searches, addSearch, removeSearch } = useSearch();
        ...
        <div className="max-w-2xl mx-auto pt-4 sm:pt-6 lg:pt-8">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 border border-gray-200 p-2 sm:p-3 mt-4 sm:mt-6 rounded-sm">
            ...
            <Button
              ...
              className="font-satoshi bg-black text-white px-4 sm:px-6 lg:px-8 py-2 sm:py-3 rounded-none font-normal text-sm sm:text-base whitespace-nowrap hover:bg-gray-800 transition-colors"
            >
              Search
            </Button>
          </div>
